...
public class Constants {
    ...
    public static final String API_OBJECT_PATH = CLASSPATH + API_OBJECT_FOLDER + File.separator;
    ...
    public static final String SERVICES_PATH = CLASSPATH+"/apiobjects/services/";
